...
<!DOCTYPE html>
<main>
  <title>Inner Nourish Counseling | Therapist Sign Up</title>
  ...
  <header>
      ...
      <ul class="main-nav2">
        ...
        <li><a href="t_signup.php"> ADD THERAPIST </a></li>
  ...
  <div id="id01" class="modal">
    <form class="modal-content animate" action="../includes/t_signup.inc.php" method="post">
      ...
      <div class="container">
        ...
        <input type="text" name="phoneNumber" placeholder="(888)-888-8888">
        <br/><br/>
